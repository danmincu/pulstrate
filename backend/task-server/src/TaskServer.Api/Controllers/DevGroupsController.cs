...
/// <summary>
/// Development-only controller for testing group operations without authentication.
/// </summary>
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/dev/groups")]
[AllowAnonymous]
public class DevGroupsController : ControllerBase
{
    ...
    private readonly ILogger<DevGroupsController> _logger;
    private readonly IWebHostEnvironment _environment;

    public DevGroupsController(
        ITaskGroupService groupService,
        ITaskRepository taskRepository,
        ITaskQueue taskQueue,
        ILogger<DevGroupsController> logger,
